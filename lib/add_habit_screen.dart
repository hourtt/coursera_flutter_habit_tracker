...
class _AddHabitScreenState extends State<AddHabitScreen> {
  ...
  String selectedColorName = 'Amber'; //* Set default selected color name
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.blue.shade700, title: Text('Configure Habits')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                if (_habitController.text.isNotEmpty) {
                  setState(() {
                    ...
                    selectedHabitsMap[_habitController.text] = selectedColor.value.toRadixString(
                      16,
                    );
              ...
              child: Text('Add Habit', style: TextStyle(color: Colors.white, fontSize: 16)),
            ),
            const SizedBox(height: 20),
            Expanded(
              child: ListView(
